...
public class SecantActivity extends AppCompatActivity {
    ...
    public void drawFunction() {
        try {
            ...
            Secant secant = new Secant (function);
            ...
            secant.drawFunction(_a, _b, function);
            textViewBisection.setText("Zero of function: " + Float.parseFloat(String.valueOf(Double.valueOf(secant.getSecant(a,b)))));

            LineDataSet lineDataSet = new LineDataSet(secant.getLineEntries(), "Function");
