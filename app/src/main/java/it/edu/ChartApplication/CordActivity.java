...
import it.edu.ChartApplication.Functions.Cord;
import it.edu.ChartApplication.Functions.Secant;
...
public class CordActivity extends AppCompatActivity {
    ...
    public void drawFunction() {
        try {
            ...
            cord.drawFunction(_a, _b, function);
            textViewBisection.setText("Zero of function: " + Float.parseFloat(String.valueOf(Double.valueOf(cord.getCord(a,b)))));

            LineDataSet lineDataSet = new LineDataSet(cord.getLineEntries(), "Function");
