...
import it.edu.ChartApplication.Functions.NewtonRaphson;

public class NewtonRaphsonActivity extends AppCompatActivity {
    ...
    public void drawFunction() {
        try {
            ...
            newtonRaphson.drawFunction(_a, _b, function);
            textViewBisection.setText("Zero of function: " + Float.parseFloat(String.valueOf(Double.valueOf(newtonRaphson.getMethod(a,b)))));

            LineDataSet lineDataSet = new LineDataSet(newtonRaphson.getLineEntries(), "Function");
